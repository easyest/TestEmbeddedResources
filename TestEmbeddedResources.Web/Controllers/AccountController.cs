...
using TestEmbeddedResources.Sessions;
using TestEmbeddedResources.Web.Controllers.Results;
using TestEmbeddedResources.Web.Models;
using TestEmbeddedResources.Web.Models.Account;
...
{
    public class AccountController : TestEmbeddedResourcesControllerBase
    {
