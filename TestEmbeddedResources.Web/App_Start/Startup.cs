...
﻿using Abp.Owin;
using TestEmbeddedResources.Api.Controllers;
using TestEmbeddedResources.Web;
...
namespace TestEmbeddedResources.Web
{
    public class Startup
    {
        public void Configuration(IAppBuilder app)
        {
            ...
            //ENABLE TO USE HANGFIRE dashboard (Requires enabling Hangfire in TestEmbeddedResourcesWebModule)
